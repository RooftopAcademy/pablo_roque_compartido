...
/***/ "./src/helpers/cardProductEvent.ts":
/*!*****************************************!*\
  !*** ./src/helpers/cardProductEvent.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ blackCard)\n/* harmony export */ });\nfunction blackCard() {\n    var caja = document.querySelectorAll('.caja');\n    console.log(caja);\n    caja.forEach(function (element) {\n        element.addEventListener('click', function () {\n            element.classList.toggle('tarjeta');\n        });\n    });\n}\n\n\n//# sourceURL=webpack://08-09/./src/helpers/cardProductEvent.ts?");
...
/******/ 	__webpack_require__("./src/helpers/cardProductEvent.ts");
